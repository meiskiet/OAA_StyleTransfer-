...
class Vgg16_Extractor(nn.Module):
    ''' Sets up the VGG16 layers, freezes their parameters (to avoid training them),
        and defines layers where features will be captured.'''
    ...
    '''These methods are used to pass an image through the network and extract features at specified layers.'''
